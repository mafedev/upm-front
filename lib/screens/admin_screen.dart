...
class _AdminScreenState extends State<AdminScreen> {
  ...
  Future<void> confirmReset() async {
    ...
    if (result == true) {
      await widget.serialService.send('6'); // envía el comando principal
      await Future.delayed(const Duration(milliseconds: 200));
      await widget.serialService.send('1234'); // confirma el reinicio
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text("Panel de administrador", style: TextStyle(color: Colors.white70)),
                    const SizedBox(height: 5),
                    Text(
